...
class _PostViewState extends State<PostView> {
  ...
  Future refresh() async {
    ...
    if(postsList.isEmpty){
      ...
      postsList = await HttpService.GET(HttpService.API_SEARCH_LIST, HttpService.paramsSearch(page: page, topic: widget.search!.isNotEmpty ? widget.search! : widget.post!.urls.regular));
    }
    else{
      setState(() {
        page += 1;
      });
      postsList.addAll(await HttpService.GET(HttpService.API_SEARCH_LIST, HttpService.paramsSearch(page: page, topic: widget.search!.isNotEmpty ? widget.search! : widget.post!.urls.regular)));
    }
