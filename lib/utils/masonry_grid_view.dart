...
import 'package:pinterest/pages/detail/view.dart';
...
class _PostState extends State<Post> {
  ...
  Future refresh() async {
    ...
    // ?  await HttpService.GET(HttpService.API_LIST, HttpService.paramsGET())
        ? await HttpService.GET(HttpService.API_SEARCH_LIST,
        HttpService.paramsSearch(page: page, topic: 'All'))
        : widget.pageIndex == 0 && widget.tabIndex == 1
        ? await HttpService.GET(HttpService.API_LIST,
        HttpService.paramsGET(page: page, sortBy: 'latest'))
        : widget.pageIndex == 0 && widget.tabIndex == 2
        ? await HttpService.GET(
        HttpService.API_LIST, HttpService.paramsGET(page: page))
        : widget.pageIndex == 0 && widget.tabIndex == 3
        ? await HttpService.GET(HttpService.API_SEARCH_LIST,
        HttpService.paramsSearch(page: page, topic: 'health'))
        : widget.pageIndex == 0 && widget.tabIndex == 4
        ? await HttpService.GET(HttpService.API_SEARCH_LIST,
        HttpService.paramsSearch(page: page, topic: 'recipes'))
        : widget.pageIndex == 1
        ? await HttpService.GET(
        HttpService.API_SEARCH_LIST,
        HttpService.paramsSearch(
              ...
              Flexible(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    ...
                    // const Image(image: AssetImage('assets/cache/img.png')),
                    AspectRatio(
                    ...
                    const Image(image: AssetImage('assets/cache/img_1.png')),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
                    ...
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        ...
                        placeholder: (context, url) => const Image(
                            image: AssetImage('assets/cache/img.png')),
                        errorWidget: (context, url, error) => const Image(
                            image: AssetImage('assets/cache/img_1.png')),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
